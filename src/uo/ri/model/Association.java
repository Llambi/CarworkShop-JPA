...
public class Association {
	...
	public static void unlink(Cliente cliente,
		Vehiculo vehiculo) {
	...
	public static void link(MedioPago medioPago,
		Cliente cliente) {
	...
	protected static void link(Averia averia,
		Intervencion intervencion, Mecanico mecanico) {
	...
	public static void link(Repuesto repuesto,
		Sustitucion sustitucion, Intervencion intervencion) {
