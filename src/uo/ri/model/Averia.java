...
public class Averia {
	...
	return "Averia{" + "descripcion='" + descripcion + '\''
		...
		+ ", status=" + status + ", vehiculo=" + vehiculo
		+ '}';
    }
     ...
     * pasa a TERMINADA
     *
     * @throws IllegalStateException si - La avería no está en estado ASIGNADA, o -
     ...
     *
     * @throws IllegalStateException si - La averia no está en estado FACTURADA, o -
     ...
     *
     * @throws IllegalStateException si - La averia no está en estado TERMINADA, o -
     ...
     *
     * @throws IllegalStateException si - La averia no está en estado ASIGNADA, o
     * @see Diagramas de estados en el enunciado de referencia
     */
