...
public interface ContractCategoryCrudService {
     ...
     */
    void addContractCategory(ContractCategoryDto dto)
     ...
     */
    void updateContractCategory(ContractCategoryDto dto)
	    throws BusinessException;

    /**
     * @param id, of the category
     * @return the contract category dto, or null if the id is not registered
     * @throws BusinessException DOES NOT
     */
    ContractCategoryDto findContractCategoryById(Long id)
	    throws BusinessException;
     ...
     * @throws BusinessException DOES NOT
     */
    List<ContractCategoryDto> findAllContractCategories()
	    throws BusinessException;
