...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    @Override
    public List<PaymentMeanDto> findPayMethodsForInvoice(
	    Long idInvoiceDto) throws BusinessException {
	return executor
		.execute(new FindPayMethodsForInvoice(idInvoiceDto));
    }

    @Override
    public void settleInvoice(Long idInvoiceDto,
	    Map<Long, Double> cargos) throws BusinessException {
