...
public class DtoAssembler {
    ...
    public static List<ClientDto> toClientDtoList(
    ...
    public static List<MechanicDto> toMechanicDtoList(
	    List<Mecanico> list) {
    ...
    public static List<PaymentMeanDto> toPaymentMeanDtoList(
	    List<MedioPago> list) {
	return list.stream().map(DtoAssembler::toDto)
	...
	if (mp instanceof Bono) {
	    ...
	    throw new RuntimeException(
		    "Unexpected type of payment mean");
	}
    }

    public static List<BreakdownDto> toBreakdownDtoList(
	    List<Averia> list) {
	return list.stream().map(DtoAssembler::toDto)
		.collect(Collectors.toList());
    }
    ...
    public static ContractCategoryDto toDto(
    ...
    public static List<PayrollDto> toPayrollDtoList(
	    List<Payroll> list) {
	return list.stream().map(DtoAssembler::toDto)
		.collect(Collectors.toList());
    }
