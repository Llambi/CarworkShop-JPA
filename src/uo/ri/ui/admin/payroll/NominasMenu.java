...
public class NominasMenu extends BaseMenu {
	...
	menuOptions = new Object[][] {
		...
		{ "Listar nóminas de un empleado",
			ListMechanicPayrollsAction.class },
		{ "Ver detalle de una nómina",
			ViewPayrollDetailAction.class },
		{ "Eliminar última nómina de empleado",
			DeleteLastMechanicPayrollAction.class },
		{ "Eliminar nóminas del último mes",
			DeleteLastMonthPayrollsAction.class },
		{ "Generar nóminas",
			GeneratePayrollsAction.class }, };
    }
